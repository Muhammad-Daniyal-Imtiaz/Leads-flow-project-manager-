...
import { graphicDesignTasks, getTasksByPhase, Task } from '@/lib/data/graphic-design-tasks';
import PhaseSection from '@/components/ui/PhaseSection';

export default function GraphicDesignChecklistPage() {
  const [tasks, setTasks] = useState<Task[]>(graphicDesignTasks);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Graphic Design Checklist</h1>
          <p className="text-gray-600">Track and manage graphic design projects for your clients</p>
        </div>
