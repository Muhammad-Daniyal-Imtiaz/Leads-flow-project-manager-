...
const SocialMediaTemplate: React.FC<SocialMediaTemplateProps> = ({ onCreateProject, projects, onProjectClick }) => {
  ...
  useEffect(() => {
    const fetchTemplate = async () => {
      try {
        ...
        const socialTemplate = data.templates.find((t: any) => t.category === 'Social Media');
        setTemplateData(socialTemplate);
      } catch (error) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-bold text-gray-800">Social Media Projects</h2>
        ...
        <div className="mb-6 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="space-y-4">
            {templateData.templatephases?.map((phase: any) => (
              <div key={phase.templatephaseid} className="border-l-4 border-purple-500 pl-4">
      ...
      {showCreate && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg w-96">
            <h3 className="text-xl font-semibold mb-4">Create Social Media Project</h3>
            <div className="mb-4 p-3 bg-purple-50 border border-purple-200 rounded-md">
